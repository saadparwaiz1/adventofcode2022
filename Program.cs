...
var host = Host.CreateDefaultBuilder(args)
                    .ConfigureServices((_, services) =>
                    {
                        ...
                        services.AddSingleton<Eleventh>();
                    }).Build();
...
var types = new Type[] { typeof(First), typeof(Second), typeof(Third), typeof(Fourth), typeof(Fifth), typeof(Sixth), typeof(Seventh), typeof(Eighth), typeof(Tenth), typeof(Eleventh) };
